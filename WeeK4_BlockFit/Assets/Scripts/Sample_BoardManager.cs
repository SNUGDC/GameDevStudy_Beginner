...
{
    public static Sample_BoardManager instance;

    public int boardSize;
    public GameObject tilePrefab;
    public GameObject blockPrefab;
    public List<Sprite> blockSprite;
    public List<Sample_Blocks> type;
    ...
    private GameObject CreateBlock(int typeNum, int color)
    {
        ...
        for (int i = 0; i < targetBlock.Count; i++)
        {
            ...
            singleBlock.GetComponent<Sample_BlockController>().myType = typeNum;
        }
    ...
    public bool CheckFit()
    {
        ...
        int blockType = holdingBlock.transform.GetComponentInChildren<Sample_BlockController>().myType;
